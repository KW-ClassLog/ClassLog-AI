...
def transcribe_audio(file_path: str, chunk_sec: int = 180, api_key: str = "") -> str:
    ...
    def process_chunk(idx: int, chunk_audio: AudioSegment):
        try:
            with BytesIO() as buffer:
                ...
                return idx, transcript.text.strip()
